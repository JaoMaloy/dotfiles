def blood(c, options = {}):
    ...
    ## Type: QtColor
    c.colors.tabs.even.fg = palette['selection']
    ...
    ## Type: QtColor
    c.colors.tabs.odd.fg = palette['selection']
    ...
    # ## Type: QtColor
    c.colors.tabs.selected.even.fg = palette['foreground-attention']
    ...
    # ## Type: QtColor
    c.colors.tabs.selected.odd.fg = palette['foreground-attention']
